function net = training(net, x, labels, x_val, labels_val, opts)
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
                     ...
                     net.layers{i}.params.(s) = net.layers{i}.params.(s) - opts.learning_rate * (momentum{i}.(s)+opts.weight_decay*net.layers{i}.params.(s)); % w_n+1=w_n-alpha*(m_n+weightdecay*w_n) with weight decay
